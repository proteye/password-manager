...
import "package:password_manager/src/utils/convert.util.dart";
...
class CryptHelper {
  ...
  static Uint8List encryptBytes(String password, Uint8List textBytes,
      {String mode = CBC_MODE}) {
    Uint8List derivedKey = deriveKey(password);
    KeyParameter keyParam = new KeyParameter(derivedKey);
    BlockCipher aes = new AESFastEngine();
  ...
  static Uint8List decryptBytes(String password, Uint8List cipherIvBytes,
      {String mode = CBC_MODE}) {
    Uint8List derivedKey = deriveKey(password);
    KeyParameter keyParam = new KeyParameter(derivedKey);
    BlockCipher aes = new AESFastEngine();
